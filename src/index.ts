...
const modes: NodeListOf<HTMLInputElement> = document.querySelectorAll("#mode-list .mode");
...
const converter: Converter = new Converter("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ", 10);
